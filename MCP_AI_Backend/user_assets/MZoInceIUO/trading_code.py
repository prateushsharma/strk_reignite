...
def filter_decision(decision, data, risk="low"):
    ...
    if new_decision != original_decision:
        with open(f"./user_assets/MZoInceIUO/data_log.txt", "a", encoding="utf-8") as f:
...
if __name__ == "__main__":
    wallet = {
  "address": "0xa55140a06eec9c9b00e5c7049d7ad9a54facf96b2baf0ec73e11bb19821b215d",
  "privateKey": {
    "keypair": {
      "publicKey": {
        "0": 199,
  ...
  "secretKey": "suiprivkey1qr492fpqastv3m349g26jvj4uanhfctgf95ls5nx0qx2ldsvs7gc6ksucrk"
}
    wallet = Wallet(**wallet)
    risk_status = "med"
    log_file_path = "./user_assets/MZoInceIUO/data_log.txt"
    try:
        curr_status = "liq"
