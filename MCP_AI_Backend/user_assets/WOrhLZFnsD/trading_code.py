...
def filter_decision(decision, data, risk="low"):
    ...
    if new_decision != original_decision:
        with open(f"./user_assets/WOrhLZFnsD/data_log.txt", "a", encoding="utf-8") as f:
...
if __name__ == "__main__":
    wallet = {
  "address": "0x1cc13a54e81ddeaf596d7f552876bd111194de2dd18d36319ab69e40f8efd5a8",
  "privateKey": {
    "keypair": {
      "publicKey": {
        "0": 225,
  ...
  "secretKey": "suiprivkey1qqg6fm7v3hpmuf8l22dkcyxcd8gc7epqxepz32gsnxnz5d8adpgpuauhmu5"
}
    wallet = Wallet(**wallet)
    risk_status = "high"
    log_file_path = "./user_assets/WOrhLZFnsD/data_log.txt"
    try:
        curr_status = "liq"
