...
def filter_decision(decision, data, risk="low"):
    ...
    if new_decision != original_decision:
        with open(f"./user_assets/bZjFuiFfIi/data_log.txt", "a", encoding="utf-8") as f:
...
if __name__ == "__main__":
    wallet = {
  "address": "0xe0ea625b7e40267cc116f90051ec1c32a266123bba364d7671d598bc1b765fad",
  "privateKey": {
    "keypair": {
      "publicKey": {
        "0": 96,
  ...
  "secretKey": "suiprivkey1qprwrlzrhage2p03h750te2wnnhwswmqeu69xtcqk2wgerpazul4xfnc33p"
}
    wallet = Wallet(**wallet)
    risk_status = "med"
    log_file_path = "./user_assets/bZjFuiFfIi/data_log.txt"
    try:
        curr_status = "liq"
