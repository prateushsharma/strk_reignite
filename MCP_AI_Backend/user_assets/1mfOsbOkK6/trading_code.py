...
def filter_decision(decision, data, risk="low"):
    ...
    if new_decision != original_decision:
        with open(f"./user_assets/1mfOsbOkK6/data_log.txt", "a", encoding="utf-8") as f:
...
if __name__ == "__main__":
    wallet = {
  "address": "0x17c496d43f8f33df1b3d514e12c6065105851bde11174df3c9de21a8dcb4b3dc",
  "privateKey": {
    "keypair": {
      "publicKey": {
        "0": 6,
  ...
  "secretKey": "suiprivkey1qqpdur2ct6sw30q344xq47x6xljeptzjnlrp8gnf8weue9v050gjktdgk88"
}
    wallet = Wallet(**wallet)
    risk_status = "med"
    log_file_path = "./user_assets/1mfOsbOkK6/data_log.txt"
    try:
        curr_status = "liq"
